...
export const ArticleCard:React.FC<any> = (props) => {
  ...
  return (
<div className='flex rounded-xl overflow-x-hidden bg-blue-50 h-56 m-4' key={id} onClick={() => openItemHandle(id)}>
    <div style={{ backgroundImage: `url(${coverUrl})`, backgroundColor: '#ccc' }} className='w-7/12 bg-contain bg-center h-full'/>
    <div className='h-full flex-auto w-9/12 flex flex-col pt-10 pl-6'>
